...
function Sprite:getWidth() return self.texture:getWidth() or 0 end
function Sprite:getHeight() return self.texture:getHeight() or 0 end
function Sprite:getDimensions() return self.texture:getWidth() or 0, self.texture:getHeight() or 0 end
...
function Sprite:set_hframes(vl)
	...
	if self.quads and #self.quads ~= 0 then
		for idx=1,#self.quads do self.quads[idx]:release() end
	end
