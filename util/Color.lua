...
local Color = {
	...
	LAVENDER = function()
		return { 230 / 255, 230 / 255, 250 / 255, 1 }
	end,
	INDIGO = function()
		return { 75 / 255, 0, 130 / 255, 1 }
	end,
	GREEN_YELLOW = function()
		return { 173 / 255, 1, 47 / 255, 1 }
	end,
	PALE_GREEN = function()
		return { 152 / 255, 251 / 255, 152 / 255, 1 }
	end,
	GRAY = function()
