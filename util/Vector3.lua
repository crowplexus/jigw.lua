...
function Vector3:round()
	return Vector3:construct(math.floor(self.x + 0.5), math.floor(self.y + 0.5), math.floor(self.z + 0.5))
end
...
function Vector3:sortByY(o, a, b)
	...
	if not Vector3.is(a) or not Vector3.is(b) then
		return 0
	end
...
function Vector3:sortByZ(o, a, b)
	...
	if chk then
		return o < 0 and a.z > b.z or a.z < b.z
	end
	return false
end
